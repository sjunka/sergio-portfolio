  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl w-full text-center">
        ...
        <motion.div {...fadeUp(0.2)}>
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-foreground mb-4 leading-none">
            ...
            <span
              ...
              style={{
                backgroundImage: 'linear-gradient(135deg, hsl(var(--primary)), hsl(271 91% 65%))',
              }}
            >
              Junca
            </span>
        ...
        {/* Subtitle pill row */}
        <motion.div {...fadeUp(0.45)} className="flex flex-wrap items-center justify-center gap-2 mb-8">
          {['React Native', 'TypeScript', 'iOS & Android', '10+ Years'].map(tag => (
            <span
              key={tag}
        ...
        <motion.div {...fadeUp(0.55)}>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-10">
            ...
            <strong className="text-foreground font-medium">fintech, gaming, healthcare,</strong> and{' '}
            <strong className="text-foreground font-medium">logistics</strong> — from architecture to App Store.
          </p>
        </motion.div>

        {/* CTAs */}
        <motion.div {...fadeUp(0.65)} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <a
            href="#experience"
            className={cn(
