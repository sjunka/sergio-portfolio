export const en = {
  ...
  landing: {
    ...
    lede: 'Senior mobile engineer. React Native, iOS and Android, from the first commit to the store listing. Ten years across fintech, gaming, healthcare and logistics.',
