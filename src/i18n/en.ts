export const en = {
  ...
  hero: {
    ...
    tags: ['React Native', 'TypeScript', 'iOS & Android', 'AI Agents'],
  ...
  about: {
    ...
    bio1Pre: "I'm a ",
    bio1Strong: 'software engineer and AI engineering lead',
    bio1Post: ' who ships production React Native across fintech, gaming, healthcare and logistics, and now designs the specs, contracts and guardrails that let AI agents build alongside the team.',
  ...
  landing: {
    eyebrow: 'Shipping mobile since 2014',
    headlineA: 'I build the apps',
    headlineB: 'that live in your pocket',
    lede: 'Software engineer and AI engineering lead. React Native, iOS and Android, from the first commit to the store listing. Now building the specs, agents and feedback loops that ship the next one faster.',
    readWriting: 'Read the writing',
    aboutMe: 'About me',
    phoneLabel: 'Interactive phone home screen — the apps open sections of this site',
    apps: {
      about: 'About',
      blog: 'Writing',
      resume: 'Resume',
    ...
    marks: {
      ...
      industries: 'industries',
      platforms: 'platforms, one codebase',
      stores: 'store submissions',
    },
    writingLabel: 'Latest writing',
    writingTitle: 'Notes from the build',
    writingLede: 'What I learn shipping mobile apps: performance work, release discipline, and the parts of React Native nobody blogs about.',
    allPosts: 'All posts',
    industriesLabel: 'Where the code shipped',
    contactLabel: 'Hiring, or want to talk shop?',
    contactCta: 'Send me a note',
  },
  blog: {
    label: 'Writing',
    title: 'Notes from the build',
    lede: 'Performance work, release discipline, and the parts of React Native nobody blogs about. Newest first.',
    postCount: 'posts',
    filterAll: 'All',
    filterLabel: 'Filter posts by tag',
    empty: 'No posts with that tag yet.',
    readPost: 'Read post',
    minRead: 'min read',
    backToBlog: 'All writing',
    notFoundTitle: 'That post moved, or never existed',
    notFoundBody: 'The link is broken. The writing index has everything that is published.',
    nextPost: 'Next',
    prevPost: 'Previous',
  ...
  notFound: {
    ...
    body: 'The page you asked for is not here. Try the landing page or the writing index.',
